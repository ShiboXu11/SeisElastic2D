...
REAL(KIND=CUSTOM_REAL), PARAMETER :: deltat=2.0e-4 
REAL(KIND=CUSTOM_REAL), PARAMETER :: t0=0.0 
REAL(KIND=CUSTOM_REAL), PARAMETER :: f0=10 
INTEGER, PARAMETER :: NREC=162 
INTEGER, PARAMETER :: NSRC=8 
...
REAL(KIND=CUSTOM_REAL), PARAMETER :: min_step_length=0.00000001 
...
LOGICAL :: MASK_STATION=.true.
LOGICAL :: MASK_DAMP=.true.
LOGICAL :: MASK_MODEL=.false.
REAL(KIND=CUSTOM_REAL), PARAMETER :: source_radius=20 
REAL(KIND=CUSTOM_REAL), PARAMETER :: station_radius=20 
INTEGER, PARAMETER :: mask_z=500
INTEGER, PARAMETER :: mask_zend=540
